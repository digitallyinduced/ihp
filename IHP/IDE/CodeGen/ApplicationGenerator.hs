...
generateGenericApplication applicationName =
        let
            ...
            welcomeViewStaticHs = 
             ...
             <>"        <h1 style=\"margin-bottom: 2rem; font-size: 2rem; font-weight: 300;\n" 
             <>"                      border-bottom: 1px solid white; padding-bottom: 0.25rem; border-color: hsla(196, 13%, 60%, 1)\">λ IHP</h1>\n"
             ...
             <>"                   text-decoration: none; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px hsla(205, 69%, 0%, 0.08);\n" 
