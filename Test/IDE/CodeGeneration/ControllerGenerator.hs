    ...
    describe "Controller Generator Tests:" do
        ...
        it "should build a controller with name \"people\"" do
            ...
            builtPlan `shouldBe` [
                ...
                , EnsureDirectory {directory = "Web/View/People"}
                , CreateFile {filePath = "Web/View/People/Edit.hs", fileContent = "import Web.View.People.Show"}

                , EnsureDirectory {directory = "Web/View/People"},CreateFile {filePath = "Web/View/People/Edit.hs", fileContent = "module Web.View.People.Edit where\nimport Web.View.Prelude\n\ndata EditView = EditView { person :: Person }\n\ninstance View EditView where\n    html EditView { .. } = [hsx|\n        {breadcrumbs}\n        <h1>Edit Person</h1>\n        {renderForm person}\n\n    renderForm :: Person -> Html\n    renderForm person = formFor person [hsx|\n        \n        {submitButton}\n    \n    |]\n\n    |]\n        where\n            breadcrumbs = renderBreadcrumbs\n                [ BreadcrumbsItem { label = pluralName, url = Just $ pathTo indexAction, isActive = False }\n                , BreadcrumbsItem { label = [hsx|Edit {singularName}|], url = Nothing , isActive = True}\n                ]"}
