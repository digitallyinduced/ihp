    ...
    describe "CSS Framework" do
        describe "bootstrap" do
            ...
            describe "text field" do
                ...
                it "should render with multiple" do
                    let textField = baseTextField { multiple = True }
                    styledFormField cssFramework cssFramework textField `shouldRenderTo` "<div class=\"form-group\" id=\"form-group-fname\"><label class=\"\" for=\"fname\">First name:</label><input type=\"text\" name=\"firstname\" placeholder=\"Your firstname\" id=\"fname\" class=\"form-control\" multiple=\"multiple\"></div>"
            ...
            describe "select" do
                ...
                it "should render with multiple" do
                    let select = baseSelect { multiple = True }
                    styledFormField cssFramework cssFramework select `shouldRenderTo` "<div class=\"form-group\" id=\"form-group-project_user_id\"><label class=\"\" for=\"project_user_id\">User</label><select name=\"user_id\" id=\"project_user_id\" class=\"form-control\" value=\"\" multiple=\"multiple\"><option selected=\"selected\" disabled=\"disabled\">Please select</option><option value=\"a\">First Value</option><option value=\"b\">Second Value</option></select></div>"
