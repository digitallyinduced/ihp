...
postgresTypeToGraphQLType (PSetOf _) = error "PSetOf cannot be converted as a table-column GraphQL type"
postgresTypeToGraphQLType (PTable _) = error "PTable cannot be converted as a table-column GraphQL type"
