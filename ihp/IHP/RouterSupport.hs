                    ...
                    >> case expectedTypedJson (toDyn view) of
                        ...
                        Just expectedJson ->
                            unless
                                ...
                                (throwOpenApiRenderMismatch ("OpenAPI docs expect the JSON generated from json of view " <> cs expectedViewTypeName <> ", but render produced a different JSON value"))
