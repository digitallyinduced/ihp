...
import IHP.QueryBuilder.Compiler (buildQuery, compileOperator)
...
-- | Typeclass for types that can be encoded as Hasql parameters
--
-- This uses hasql-implicits' DefaultParamEncoder instances under the hood.
class HasqlParam a where
    toSnippetParam :: a -> Snippet

instance HasqlParam UUID where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe UUID) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Text where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Text) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Int where
    toSnippetParam x = Snippet.param (fromIntegral x :: Int64)
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Int) where
    toSnippetParam (Just x) = Snippet.param (fromIntegral x :: Int64)
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Integer where
    toSnippetParam x = Snippet.param (fromIntegral x :: Int64)
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Integer) where
    toSnippetParam (Just x) = Snippet.param (fromIntegral x :: Int64)
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Int64 where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Int64) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Bool where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Bool) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Double where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Double) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Float where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Float) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam UTCTime where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe UTCTime) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam LocalTime where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe LocalTime) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Day where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Day) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam TimeOfDay where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe TimeOfDay) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Scientific where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Scientific) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam ByteString where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe ByteString) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

instance HasqlParam Value where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}

instance HasqlParam (Maybe Value) where
    toSnippetParam (Just x) = Snippet.param x
    toSnippetParam Nothing = Snippet.sql "NULL"
    {-# INLINE toSnippetParam #-}

-- Array instances use the implicit encoders as well
instance HasqlParam [UUID] where
    toSnippetParam = Snippet.param
    {-# INLINE toSnippetParam #-}
...
instance HasqlParam [Int] where
    toSnippetParam xs = Snippet.param (map (fromIntegral :: Int -> Int64) xs)
    {-# INLINE toSnippetParam #-}

instance HasqlParam [Integer] where
    toSnippetParam xs = Snippet.param (map (fromIntegral :: Integer -> Int64) xs)
    {-# INLINE toSnippetParam #-}
