...
tests = do
    describe "CSS Framework" do
        describe "bootstrap5" do
            ...
            describe "text field" do
                ...
                it "should render" do
                    ...
                    styledFormField cssFramework cssFramework textField `shouldRenderTo` "<div class=\"mb-3\" id=\"form-group-fname\"><label class=\"form-label\" for=\"fname\">First name:</label><input type=\"text\" name=\"firstname\" placeholder=\"Your firstname\" id=\"fname\" class=\"form-control\"> </div>"

                it "should render with disabled" do
                    let textField = baseTextField { disabled = True }
                    styledFormField cssFramework cssFramework textField `shouldRenderTo` "<div class=\"mb-3\" id=\"form-group-fname\"><label class=\"form-label\" for=\"fname\">First name:</label><input type=\"text\" name=\"firstname\" placeholder=\"Your firstname\" id=\"fname\" class=\"form-control\" disabled=\"disabled\"> </div>"

                it "should render a validation error" do
                    let textField = baseTextField { validatorResult = Just (TextViolation "should not be empty") }
                    styledFormField cssFramework cssFramework textField `shouldRenderTo` "<div class=\"mb-3\" id=\"form-group-fname\"><label class=\"form-label\" for=\"fname\">First name:</label><input type=\"text\" name=\"firstname\" placeholder=\"Your firstname\" id=\"fname\" class=\"form-control is-invalid\"><div class=\"invalid-feedback\">should not be empty</div> </div>"

                it "should render with disableLabel = True" do
                    let textField = baseTextField { disableLabel = True }
                    styledFormField cssFramework cssFramework textField `shouldRenderTo` "<div class=\"mb-3\" id=\"form-group-fname\"><input type=\"text\" name=\"firstname\" placeholder=\"Your firstname\" id=\"fname\" class=\"form-control\"> </div>"

                it "should render with disableGroup = True" do
                    let textField = baseTextField { disableGroup = True }
                    styledFormField cssFramework cssFramework textField `shouldRenderTo` "<label class=\"form-label\" for=\"fname\">First name:</label><input type=\"text\" name=\"firstname\" placeholder=\"Your firstname\" id=\"fname\" class=\"form-control\"> "
            ...
            describe "checkbox" do
                ...
                it "should render with disableLabel = True" do
                    ...
                    styledFormField cssFramework cssFramework checkbox `shouldRenderTo` "<div class=\"mb-3\" id=\"form-group-user_is_active\"><div class=\"form-check\"><div><input type=\"checkbox\" name=\"is_active\" class=\"form-check-input\" id=\"user_is_active\" checked=\"checked\"><input type=\"hidden\" name=\"is_active\" value=\"off\">  </div></div></div>"
        ...
        describe "bootstrap4" do
            let cssFramework = bootstrap4
