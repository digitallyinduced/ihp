...
, hasql-pool, hspec, ihp, ip, lib, postgresql-libpq
, postgresql-syntax, process, scientific, string-conversions
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    hasql-dynamic-statements hasql-pool ihp ip postgresql-libpq
    postgresql-syntax scientific string-conversions template-haskell
    text
  ];
  testHaskellDepends = [
