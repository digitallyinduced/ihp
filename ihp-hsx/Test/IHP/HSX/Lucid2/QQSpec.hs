{-|
Module: IHP.HSX.Lucid2.QQSpec
Copyright: (c) digitally induced GmbH, 2020
-}
module IHP.HSX.Lucid2.QQSpec where
...
import Data.Text
import IHP.HSX.Lucid2.CustomHsxCases
...
tests = do
    describe "Lucid2.HSX" do
        ...
        it "should support infix notation for standard constructors e.g. (,):" do
            [hsx|<h1>{show $ ((,) 1 2)}</h1>|] `shouldBeHtml` "<h1>(1,2)</h1>"
        ...
        it "should support pre escaped class names" do
            ...
            let className = MkLucidAttributeRaw "a&"
        ...
        it "should support support doctype" do
            ...
            [hsx|<!DOCTYPE html><html lang="en"><body>hello</body></html>|] `shouldBeHtml` "<!DOCTYPE HTML><html lang=\"en\"><body>hello</body></html>"

    describe "Lucid.customHsx" do
...
shouldBeHtml :: HasCallStack => Html a -> LT.Text -> Expectation
shouldBeHtml hsx expectedHtml = renderText hsx `shouldBe` expectedHtml
