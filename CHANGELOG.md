...
- `sqlExecTyped` now also supports typed no-result statements such as `SET CONSTRAINTS ...`, returning `0` when PostgreSQL does not provide an affected-row count. ([#2747](https://github.com/digitallyinduced/ihp/issues/2747))
