...
The view would look like this, removing the `failedLoginAttempts` that was generated by the IDE, both for the New, and Edit files.

```haskell
-- Web/View/Users/New.hs and Web/View/Users/Edit.hs
renderForm :: User -> Html
