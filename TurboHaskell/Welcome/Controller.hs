...
<div style="background-color: #657b83; padding-top: 2rem; padding-bottom: 2rem; color:hsla(196, 13%, 96%, 1)">
    <div style="max-width: 800px; margin-left: auto; margin-right: auto">
        <h1 style="margin-bottom: 2rem; font-size: 2rem; font-weight: 300; border-bottom: 1px solid white; padding-bottom: 0.25rem; border-color: hsla(196, 13%, 60%, 1)">λ TurboHaskell</h1>
        ...
        <a
            href="https://turbohaskell.digitallyinduced.com/getting-started.html"
            ...
            target="_blank"
        >Learn the Next Steps in the Documentation</a>
    </div>
</div>
...
<head>
    ...
    <title>Welcome to TurboHaskell</title>
</head>
...
instance CreateViewContext ViewContext where
    type ControllerContext ViewContext = ()
    createViewContext = return ViewContext { layout = renderLayout }