...
describe('Value Transformations and basic use', () => {
	...
	['filterWhereLessThan', b => b.build(), operators.lessThan, filterWhereLessThan],
	['filterWhereLessThanOrEqual', b => b.build(), operators.lessThanOrEqual, filterWhereLessThanOrEqual],
	['filterWhereGreaterThan', b => b.build(), operators.greaterThan, filterWhereGreaterThan],
	['filterWhereGreaterThanOrEqual', b => b.build(), operators.greaterThanOrEqual, filterWhereGreaterThanOrEqual],
...
describe('ConditionBuilder', () => {
	...
	const builder = filterWhere('a', 1)
	      .filterWhereNot('b', 2)
	      .filterWhereLessThan('c', 3)
	      .filterWhereLessThanOrEqual('d', 4)
	      .filterWhereGreaterThan('e', 5)
	      .filterWhereGreaterThanOrEqual('f', 6)
