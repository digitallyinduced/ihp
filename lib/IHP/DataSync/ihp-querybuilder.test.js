...
describe('Value Transformations and basic use', () => {
	...
	['eq', b => b.build(), operators.equal, eq],
	['notEq', b => b.build(), operators.notEqual, notEq],
...
describe('QueryBuilder', () => {
    ...
    it('simple equality check with function API', () => {
	const builder = query('table')
	      .where(eq('a', 1))
    ...
    it('simple equality check with function API - filterWhere', () => {
	const builder = query('table')
	      .filterWhere(eq('a', 1))
    ...
    it('simple inequality check with function API', () => {
	const builder = query('table')
	      .where(notEq('a', 1))
    ...
    it('simple inequality check with function API - filterWhere', () => {
	const builder = query('table')
