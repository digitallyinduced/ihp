...
function initDelete() {
    document.querySelectorAll(".js-delete").forEach(e => e.addEventListener('click', handleClick));

    function handleClick(event) {
        if (event.currentTarget instanceof HTMLAnchorElement && event.currentTarget.classList.contains('js-delete')) {
