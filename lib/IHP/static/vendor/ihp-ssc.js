...
if (window.Turbo) {
    document.addEventListener('turbo:load', initalizeAllSSCComponents);
} else {
...
function initalizeSSC(component) {
    ...
    component.connection.onmessage = function (event) {
        ...
        // Previous approach used manual DOM manipulation
        // Now using custom patch system (evaluatePatch) which is more efficient
        // Turbo Frames could be used here in the future for better integration
    };
}
