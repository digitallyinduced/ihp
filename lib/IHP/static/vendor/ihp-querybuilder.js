window.IHP = {
    fetchAuthenticated(path, params) {
...
async function createRecord(table, payload) {
    const response = await IHP.fetchAuthenticated(`/api/${table}`, {
        headers: {
...
function createRecords(table, records) {
    ...
    return IHP.fetchAuthenticated(`/api/${table}`, {
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
        },
...
function updateRecordById(table, id, patch) {
    return IHP.fetchAuthenticated(`/api/${table}/${id}`, {
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
        },
