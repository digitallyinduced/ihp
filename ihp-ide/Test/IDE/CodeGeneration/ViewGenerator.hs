...
tests = do
    describe "View Generator Tests:" do
        ...
        it "should build a view with name \"Test\"" do
            ...
            builtPlan `shouldBe`
                [ EnsureDirectory {directory = textToOsPath "Web/View/Pages"},CreateFile {filePath = textToOsPath "Web/View/Pages/Test.hs", fileContent = "module Web.View.Pages.Test where\nimport Web.View.Prelude\ndata TestView = TestView\n\ninstance View TestView where\n    html TestView { .. } = [hsx|\n        {breadcrumb}\n        <h1>TestView</h1>\n        |]\n            where\n                breadcrumb = renderBreadcrumb\n                                [ breadcrumbLink \"Tests\" PagesAction\n                                , breadcrumbText \"TestView\"\n                                ]"},AddImport {filePath = textToOsPath "Web/Controller/Pages.hs", fileContent = "import Web.View.Pages.Test"}
                ]
