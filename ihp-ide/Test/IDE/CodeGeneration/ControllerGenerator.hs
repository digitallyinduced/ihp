    ...
    describe "Controller Generator Tests:" do
        ...
        it "should build a controller with name \"pages\"" do
            ...
            builtPlan `shouldBe`
                ...
                , AppendToFile {filePath = "Web/Routes.hs", fileContent = "\n[routes|PagesController\nGET /Pages PagesAction\nGET /NewPage NewPageAction\nPOST /CreatePage CreatePageAction\nGET /ShowPage?pageId ShowPageAction\nGET /EditPage?pageId EditPageAction\nPOST /UpdatePage?pageId UpdatePageAction\nDELETE /DeletePage?pageId DeletePageAction\n|]\n\n"}
        ...
        it "should build a controller with name \"page_comment\"" do
            ...
            builtPlan `shouldBe`
                ...
                , AppendToFile {filePath = "Web/Routes.hs", fileContent = "\n[routes|PageCommentController\nGET /PageComments PageCommentsAction\nGET /NewPageComment NewPageCommentAction\nPOST /CreatePageComment CreatePageCommentAction\nGET /ShowPageComment?pageCommentId ShowPageCommentAction\nGET /EditPageComment?pageCommentId EditPageCommentAction\nPOST /UpdatePageComment?pageCommentId UpdatePageCommentAction\nDELETE /DeletePageComment?pageCommentId DeletePageCommentAction\n|]\n\n"}
        ...
        it "should build a controller with name \"people\"" do
            ...
            builtPlan `shouldBe`
                ...
                , AppendToFile {filePath = "Web/Routes.hs", fileContent = "\n[routes|PeopleController\nGET /People PeopleAction\nGET /NewPerson NewPersonAction\nPOST /CreatePerson CreatePersonAction\nGET /ShowPerson?personId ShowPersonAction\nGET /EditPerson?personId EditPersonAction\nPOST /UpdatePerson?personId UpdatePersonAction\nDELETE /DeletePerson?personId DeletePersonAction\n|]\n\n"}
        ...
        it "should generate type-aware validation for a rich schema" do
            let richSchema = [
                        StatementCreateTable (table "projects") {
                            ...
                            , primaryKeyConstraint = PrimaryKeyConstraint ["id"]
                            , constraints = [
                                ForeignKeyConstraint { name = Nothing, columnName = "user_id", referenceTable = "users", referenceColumn = Nothing, onDelete = Nothing, onUpdate = Nothing }
                              ]
                        }
