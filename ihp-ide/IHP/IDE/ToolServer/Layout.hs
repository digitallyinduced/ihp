...
|]  where
        ...
        (AvailableApps appNames) = lookupRequestVault availableAppsVaultKey ?context.request
...
appUrl = let (AppUrl url) = lookupRequestVault appUrlVaultKey ?context.request in url
