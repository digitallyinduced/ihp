...
import Foundation.RouterSupport (HasPath, CanRoute)
...
run = do
    ...
    let staticMiddleware :: Middleware = staticPolicy (addBase "static/") . staticPolicy (addBase "src/Foundation/Foundation/static/")
